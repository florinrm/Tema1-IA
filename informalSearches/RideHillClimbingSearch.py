import moves
from algos.HillClimbingSearch import HillClimbingSearch
...
def RideHillClimbingSearch(clients, driver):
    ...
    for client in clients:
        ...
        result = HillClimbingSearch(state)
        if result == False:
        ...
        final = HillClimbingSearch(result)
